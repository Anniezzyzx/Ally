    ...
    init: function init() {
      ...
      function frame0() {
        ...
        mainTl.add('start').set("#screenFinal", {
          ...
          autoAlpha: 0
        }, '+=0.5').from("#screenFinal", 0.25, {
          autoAlpha: 0
        }, '-=0.5').add('scaleScreen', '-=0.5').to("#lastIcon", 1.5, {
          scale: 0.6,
          y: 54,
          x: 113,
          ease: 'sine.inOut'
          ...
          autoAlpha: 0,
          ease: 'sine.out'
        }, '-=1').add('animElements', '-=0.5').to(progress, 1.5, {
          value: rate_value,
          onUpdate: addValues,
          ease: 'sine.out'
          ...
          ease: 'sine.out'
        }, 'animElements').staggerTo("#text-01", 0.25, {
          autoAlpha: 0
        }, 0.025, '+=0.5').staggerFrom(text_ef_split.words, 0.15, {
          autoAlpha: 0,
          rotationX: 90,
          transformOrigin: 'bottom'
        }, 0.05, '+=0.2').from(['#cta', '#legal'], 0.5, {
          autoAlpha: 0,
          delay: 0.75
        }, '-=0.25');
      }
